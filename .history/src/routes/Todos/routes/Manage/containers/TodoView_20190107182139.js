      ...
      <Row center={"md"}>
        ...
        <Col md={6}>
          ...
          <Row>
            <Button
              className={styles.alphabeticSortButton}
              onClick={toggleIncompleteSortedTodos}
              disabled={loading}
            >
              Sort A to Z
            </Button>
...
const mapStateToProps = state => ({
  completedTodos: state.manageTodos.showCompletedSorted ? completedAlphabeticSortSelector(state) : completedTodosSelector(state),
  incompleteTodos: state.manageTodos.showIncompleteSorted ? incompleteAlphabeticSortSelector(state) : incompleteTodosLimitedSelector(state),
