      ...
      <Row start="md">
        ...
        >
          <div className={styles.inputBlock}>
            <Row>
              <Col md={11} className={styles.inputContainer}>
                <Field
                  name="todoItem"
                  type="input"
                  component={FormInput}
      ...
      <Row center={"md"}>
        <Col md={6}>
          ...
          <Row>
            ...
            >
              {`${
                isIncompleteSorted ? "Remove alphabetical order" : "Sort A to Z"
              }`}
            </Button>
          </Row>
          <Row start="md">
        ...
        <Col md={6}>
          ...
          <Row>
            ...
            >
              {`${
                isCompletedSorted ? "Remove alphabetical order" : "Sort A to Z"
              }`}
            </Button>
          </Row>
          <Row start="md">
