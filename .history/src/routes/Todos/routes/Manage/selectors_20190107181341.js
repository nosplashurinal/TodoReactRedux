...
import { filter, take, sortBy } from "lodash";
...
export const completedAlphabeticSortSelector = createSelector(
  [todosSelector, completedTodosSelector],
  todos => sortBy(todos, [todo => todo.name])
);

export const incompleteAlphabeticSortSelector = createSelector(
  [todosSelector, incompleteTodosSelector],
  todos => sortBy(todos, [todo => todo.name])
);
